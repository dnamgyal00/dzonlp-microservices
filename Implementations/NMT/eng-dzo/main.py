...
# model_path = os.getenv('MODEL_DIR', '/app/models/en_to_dz')
# tokenizer_path = os.getenv('TOKENIZER_DIR', '/app/models/tokenizer_en_to_dz')
model_path = os.getenv('MODEL_DIR', './model/en_to_dz')
tokenizer_path = os.getenv('TOKENIZER_DIR', './model/tokenizer_en_to_dz')
